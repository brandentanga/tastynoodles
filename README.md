...
If you feel like trying it out, clone this project, create an alias in your bash profile alias tasty="/pathtowhereeveryouputthings/tastynoodles.rb". Then you can run the following commands:
