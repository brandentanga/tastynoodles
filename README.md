...
If you feel like trying it out, clone this project, create an alias in your bash profile like the following: alias tasty="/pathtowhereeveryouputthings/tastynoodles.rb". Then you can run the following commands:
